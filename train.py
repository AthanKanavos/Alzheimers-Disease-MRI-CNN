...
from src.data import compute_training_class_weights, load_datasets
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train a reconstructed CNN for Alzheimer's MRI classification."
    )
...
def main() -> None:
    ...
    if not args.no_class_weights:
        class_weight = compute_training_class_weights(args.data_dir)
        save_json(
